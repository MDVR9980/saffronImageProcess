...
def adaptive_color_segmentation(image):
    ...
    k = 2  # Number of clusters (2 for simple foreground and background separation)
...
def create_mask(image, cluster_value=1):
    """Create a mask from clustered image based on the dominant cluster."""
